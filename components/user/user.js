angular
    ...
    .controller('userCtrl', ['$scope', '$http', function($scope, $http) {
        ...
        $http.get('http://5.44.107.29:8080/leadfleet-api/users').
        //$http.get('user.json').
        ...
        $scope.createUser = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://5.44.107.29:8080/leadfleet-api/users',
        ...
        $scope.updateUser = function () {
            ...
            $http({
                method: 'PUT',
                //url: 'http://5.44.107.29:8080/leadfleet-api/users/' + $scope.user.id,
